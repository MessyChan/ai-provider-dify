...
import { convertDifyUsage } from "./converDifyUsage";
...
export class DifyChatLanguageModel implements LanguageModelV3  {
   ...
   */
  private getRequestBody(options: LanguageModelV3CallOptions) {
  ...
  async doGenerate(options: LanguageModelV3CallOptions): Promise<LanguageModelV3GenerateResult> {
    ...
    return {
      ...
      finishReason: {
        unified: "stop",
        raw: typedData.conversation_id ?? undefined,
      } ,  
      usage: convertDifyUsage(typedData.metadata.usage),
      warnings: [],
      providerMetadata: {
        difyWorkflowData: {
